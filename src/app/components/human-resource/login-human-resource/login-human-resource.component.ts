...
@Component({
  selector: 'app-login-human-resource',
  imports: [
    CommonModule,
    ReactiveFormsModule,
    MatCardModule,
  ...
  templateUrl: './login-human-resource.component.html',
  styleUrl: './login-human-resource.component.css'
})
export class LoginHumanResourceComponent {
  ...
  onSubmit() {
    ...
    this.authService.login(dto).subscribe({
      next: (response) => {
        ...
        this.router.navigateByUrl('/human-resource/vacancies');
      },
      error: (error) => {
